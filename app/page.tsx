...
export default function BottomNav() {
  ...
  const getRect = useCallback((id: string) => {
    const el = tabRefs.current[id],
      cnt = containerRef.current;
    if (!el || !cnt) return null;
    const a = el.getBoundingClientRect(),
      b = cnt.getBoundingClientRect();
  ...
  const goToTab = useCallback(
    (id: TabId) => {
      ...
      const from = getRect(activeRef.current),
        to = getRect(id);
      if (!from || !to) return;
  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        background:
          "linear-gradient(145deg,#0d0d1a 0%,#0a1628 30%,#12082a 60%,#0d1520 100%)",
        display: "flex",
      ...
      >
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle,rgba(88,86,214,.35) 0%,transparent 70%)",
            top: -80,
            left: -60,
            filter: "blur(40px)",
          }}
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle,rgba(52,199,89,.18) 0%,transparent 70%)",
            top: 40,
            right: -40,
            filter: "blur(50px)",
          }}
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle,rgba(255,55,95,.16) 0%,transparent 70%)",
            bottom: 100,
            right: 30,
            filter: "blur(45px)",
          }}
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle,rgba(255,214,10,.10) 0%,transparent 70%)",
            top: "35%",
            left: "40%",
            filter: "blur(35px)",
          }}
        ...
        {tabs.map((t) => (
          <div
            ...
            style={{
              ...
              transition:
                "opacity 0.40s ease, transform 0.50s cubic-bezier(0.34,1.4,0.64,1)",
              pointerEvents: "none",
            }}
          >
            <div
              style={{
                fontSize: 62,
                lineHeight: 1,
                filter: "drop-shadow(0 8px 30px rgba(100,100,255,0.4))",
              }}
            >
              {t.emoji}
            </div>
        ...
        >
          <div
            style={{
              ...
              border: `0.5px solid rgba(255,255,255,${0.2 + s * 0.15})`,
          ...
          >
            <div
              style={{
                ...
                height: 1.5,
                borderRadius: 10,
                background: `rgba(255,255,255,${0.28 + s * 0.18})`,
              }}
            />
            <div
              style={{
                position: "absolute",
                inset: 0,
                background: `radial-gradient(ellipse at 50% 0%,rgba(255,255,255,${0.05 + s * 0.05}) 0%,transparent 70%)`,
              }}
            />
            <div
              style={{
                ...
                height: 1,
                borderRadius: 10,
                background: `rgba(0,0,0,${0.18 - s * 0.06})`,
              }}
            />
          </div>
          {tabs.map((tab) => {
              ...
              >
                ...
                <span
                  style={{
                    ...
                    transition:
                      "font-weight .25s, letter-spacing .25s, color .30s ease",
